...
public class EaseChatFragment extends EaseBaseFragment implements EMEventListener {
    ...
    protected EaseChatMessageList messageList;//聊天消息列表控件
    protected EaseChatInputMenu inputMenu;//聊天输入菜单栏

    protected EMConversation conversation;//代表和一个用户的对话，包含发送和接收的消息
    ...
    protected SwipeRefreshLayout swipeRefreshLayout;//google官方的下拉刷新控件
    ...
    protected EMMessage contextMenuMessage;//代表一条发送或接收到的消息
...
//            messageList.setShowUserNick(true);
        ...
        inputMenu = (EaseChatInputMenu) getView().findViewById(R.id.input_menu);//聊天页面输入按钮的下面的一块东西
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) { // 单聊
            ...
            // TODO: 2016/4/7 设置客服聊天界面标题
            titleBar.setTitle("客服");
            titleBar.setLeftImageResource(R.drawable.back_btn_selector);
        ...
        if (chatType != EaseConstant.CHATTYPE_CHATROOM) {//为单聊或者群聊
            onConversationInit();
            onMessageListInit();
        }
